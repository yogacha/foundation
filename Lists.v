...
Proof.
  intro p. destruct p as [a b]. simpl. reflexivity. Qed.
(** [] *)
...
Proof.
  destruct p as [a b]. simpl. reflexivity. Qed.
(** [] *)
...
Example test_countoddmembers1:
  ...
  unfold countoddmembers. simpl. reflexivity. Qed.
...
Compute (member 2 (remove_one 2 (remove_one 1 [2; 1; 4; 1]))).
...
Theorem app_nil_r : forall l : natlist,
  l ++ [] = l.
Proof.
  intro l. induction l as [|n t IHl'].
  - reflexivity.
...
Fixpoint eqblist (l1 l2 : natlist) : bool :=
  ...
  | nil, _ => false
  | _, nil => false
  | a :: t1, b :: t2 => (eqb a b) && (eqblist t1 t2)
  end.
...
(* zero, could not construct any due to its self-recurrsion *)
